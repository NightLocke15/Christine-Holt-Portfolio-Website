export const webDevItems = [  
    {
        ...
        <p class="paragraph">To view my Style Guide, Wireframes and goals, please view the README on this project's <a class="refLink" href="https://github.com/NightLocke15/Nudge-Mobile-App" target="_blank">GitHub page.</a></p>
...
character sheet.</p>
<p class="paragraph">To read more about my User Research, Information Architecture, Wireframes, Style Guide and Reflections on other relevant topics, please view the README on this web app's <a class="refLink" href="https://github.com/NightLocke15/DIGA4015A_2615283_ChristineHolt_ExamWebApp" target"_blank">GitHub Page</a>.</p>
`
    },
    {
        id: "3",
        ...
        <p class="paragraph">This website is designed to be simple and without fluff. The colours were chosen to perpetuate the more relaxed and fun feeling of the website. It is used as a platform to provide access to recipes without irrelevant information, as well as articles that provide further information on foods and other things, backed with facts and mixed with a few opinions. The fonts were specifically chosen for their readabulity, but also for the non-serious feel they give off.</p>
        <p class="paragraph">To read more about my wireframes, style guide and thought processes making this website, please view the <a class="refLink" href="https://nightlocke15.github.io/WSOA3029A_2615283_ChristineHolt_CommercialWebsite/about/designs.html" target="_blank">Design Log</a> on the website.</p>`,
    },
    {
        id: "4",
        ...
        <h3>Goal Alignment:</h3>
               ...
               <h3>Interface Elements</h3>
                    ...
                    <h3>Goal</h3>
                        ...
                        <p class="listItem">My goal and aesthetic for this website</p>
                            
                                <p class="listItem sub">
                    ...
                    <p class="paragraph">To view more about my process, reflections, wireframes, styleguide, information structure and user flow, please view the <a class="refLink" href="https://wits-digital-arts-interactive-media.github.io/WSOA3028A_2615283/blogs/index.html" target="_blank" >Blogs</a> and <a class="refLink" href="https://wits-digital-arts-interactive-media.github.io/WSOA3028A_2615283/designs/index.html" target="_blank">Design Logs</a> on this website.</p>
                    `
    },    
]
...
export const gameDevItems = [
    {
        ...
        github: "https://github.com/NightLocke15/Weight_Prototype",
        ...
        <p class="paragraph">To read more about my reflections, playtests and data, please view the README on this project's <a class="refLink" href="https://github.com/NightLocke15/Weight_Prototype" target="_blank">GitHub Page</a>.</p>
        `},
    {
        id: "6",
        ...
        `},
    {
        ...
        <p class="paragraph">Please Note: This was a project for a University Module.</p>
        <h3>Intent:</h3>
        <p class="paragraph"> I want to learn how to implement feedback
        elements in a certain game type.</p>
        <p class="paragraph">The game type I chose is a platformer.</p>
        <p class="paragraph">In doing this, I hope to learn how to make my games juicier.</p>
        <p class="paragraph">What do I mean by wanting to learn how to implement these elements?</p>
        <p class="listItem">I do not know how to apply screen shake.</p>
        <p class="listItem">I suck at particle systems and making them look like something.</p>
        <p class="listItem">How to use sound effects effectively escapes me and honestly terrifies me (also,
        which sound effects to use).</p>
        <p class="listItem">I do not know how to add small movements to items in the game to make them
        more alive.</p>
        <p class="paragraph">What do I mean by juicy?</p>
        <p class="listItem">In simple terms, reactive.</p>
        <p class="listItem">I want the simulation to do something when the player interacts with it.
        What do I want to explore?</p>
        <p class="listItem">As mentioned before, there is a list of feedback elements I do not know how to
        implement, and I would like to learn how to implement them.</p>
        <p class="listItem sub">I do not want to spend several prototypes on this, so I thought the best
        course of action would be to shove it all into one prototype.</p>
        <p class="listItem">I think it might be useful to have a place where I have explored these different
        aspects and a place I can refer back to when I want to implement these aspects</p>
        again.</p>
        <p class="paragraph">To read more about my reflections, playtests and data, please view the README on this project's <a class="refLink" href="https://github.com/NightLocke15/Prototype_3_Game_Design" target="_blank">GitHub Page</a>.</p>
        `
    ...
    },
    {
        ...
        status: "Completed",
        documentation:`<p class="paragraph">Please Note: This was a project for a University Module.</p>`
    },
    {
        id: "2",
        name: "Splatris",
